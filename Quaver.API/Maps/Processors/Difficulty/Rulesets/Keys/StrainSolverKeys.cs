                ...
                for (var j = i + 1; j < StrainSolverData.Count; j++)
                {
                    ...
                    if (curHitOb.Hand == nextHitOb.Hand && nextHitOb.StartTime > curHitOb.StartTime)
                    {
                        ...
                        if (!actionChordFound && !actionSameState)
                        {
                            ...
                            curHitOb.ActionStrainCoefficient = GetCoefficientValue(actionDuration, 20, 260, 57, 0.88f); // todo: temp. Apply actual constants later
                            Roll++;
                        }
                        ...
                        else if (actionSameState)
                        {
                            ...
                            curHitOb.ActionStrainCoefficient = GetCoefficientValue(actionDuration, 50, 360, 55, 1.17f); // todo: temp. Apply actual constants later
                            SJack++;
                        }
                        ...
                        else if (actionJackFound)
                        {
                            ...
                            curHitOb.ActionStrainCoefficient = GetCoefficientValue(actionDuration, 50, 370, 58, 1.09f); // todo: temp. Apply actual constants later
                            TJack++;
                        }
                        ...
                        else
                        {
                            ...
                            curHitOb.ActionStrainCoefficient = GetCoefficientValue(actionDuration, 20, 260, 60, 0.92f); // todo: temp. Apply actual constants later
                            Bracket++;
                        }
