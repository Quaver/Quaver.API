...
namespace Quaver.API.Maps.Difficulty.v1
{
    public static class PatternAnalyzer
    {
        ...
        /// <returns></returns>
        public static PatternList AnalyzeMapPatterns(IReadOnlyList<HitObjectInfo> hitObjects)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static List<JackPatternInfo> RemoveVibroFromJacks(List<JackPatternInfo> jacks, List<JackPatternInfo> vibro)
        {
        ...
        /// <returns></returns>
        public static List<HitObjectInfo> RemoveArtificialDensity(List<HitObjectInfo> hitObjects, List<TimingPointInfo> timingPoints)
        {
